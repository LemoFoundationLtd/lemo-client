...
[lemochain-distribution-sdk](https://github.com/LemoFoundationLtd/lemo-client/blob/master/README_distribution.md)
...
##### Returns
`Promise` - 通过`then`可以获取当前所有共识节点的地址列表。该地址可用于连接节点
