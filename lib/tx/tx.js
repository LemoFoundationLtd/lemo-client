...
import {CHAIN_ID_MAIN_NET, TX_VERSION, TTTL, TX_DEFAULT_GAS_LIMIT, TX_DEFAULT_GAS_PRICE, TX_DEFAULT_GAS_USED} from '../config'
...
export default class Tx {
    ...
    normalize(txConfig) {
        ...
        // gasUsed number
        this.gasUsed = parseInt(txConfig.gasUsed || TX_DEFAULT_GAS_USED, 10)
        // amount BigNumber
