...
import StaticProperties from './modules/static_properties'
import Api from './api'
...
function attachStaticProperties() {
    LemoClient.BigNumber = BigNumber
    LemoClient.TxType = StaticProperties.TxType
    LemoClient.SDK_VERSION = StaticProperties.SDK_VERSION
    LemoClient.verifyAddress = StaticProperties.verifyAddress
    LemoClient.moToLemo = StaticProperties.moToLemo
    LemoClient.lemoToMo = StaticProperties.lemoToMo
    LemoClient.toBuffer = StaticProperties.toBuffer
    LemoClient.signTx = StaticProperties.signTx
    LemoClient.signAssetTx = StaticProperties.signAssetTx
}
