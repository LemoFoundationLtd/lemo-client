...
import {DEFAULT_POLL_DURATION, MAX_POLL_RETRY, TX_POLL_MAX_TIME_OUT, NO_LAST_HEIGHT} from './const'
...
class LemoClient {
    constructor(config = {}) {
        this.config = {
            ...
            startWatchHeight: config.startWatchHeight || NO_LAST_HEIGHT, // watch block from this height. -1 means the newest block
